...
func autoConvert_v1alpha1_Worker_To_garden_Worker(in *Worker, out *garden.Worker, s conversion.Scope) error {
	...
	if in.Volume != nil {
		...
		*out = new(garden.Volume)
		if err := Convert_v1alpha1_Volume_To_garden_Volume(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Volume = nil
	...
	if in.DataVolumes != nil {
		...
		*out = make([]garden.Volume, len(*in))
		for i := range *in {
			if err := Convert_v1alpha1_Volume_To_garden_Volume(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_garden_Worker_To_v1alpha1_Worker(in *garden.Worker, out *Worker, s conversion.Scope) error {
	...
	if in.Volume != nil {
		in, out := &in.Volume, &out.Volume
		*out = new(Volume)
		if err := Convert_garden_Volume_To_v1alpha1_Volume(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Volume = nil
	...
	if in.DataVolumes != nil {
		...
		*out = make([]Volume, len(*in))
		for i := range *in {
			if err := Convert_garden_Volume_To_v1alpha1_Volume(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
